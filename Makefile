...
#AVRDUDE_VERBOSE = -v -v
AVRDUDE_VERBOSE = -v -v # -x serial_recv_timeout=100000
...
#AVRDUDE = $(HOME)/build/avrdude-5.11.1/avrdude -C $(HOME)/build/avrdude-5.11.1/avrdude.conf
#AVRDUDE = $(HOME)/build/avrdude-5.10/avrdude -C $(HOME)/build/avrdude-5.10/avrdude.conf
#AVRPATH = $(HOME)/build/avrdude-6.1
AVRPATH = $(HOME)/build/avrdude-5.11.1
AVRDUDE = $(AVRPATH)/avrdude -C $(AVRPATH)/avrdude.conf
#AVRDUDE = avrdude
